...
public class AuthControllerTest {
        ...
        void should_getEmptyCookies_when_signingOut() throws Exception {
                ...
                var refreshResult = mockMvc.perform(post("/auth/signout").cookie(authCookies))
                                ...
                                post("/auth/reset-password")
                                                ...
                                                .content(
                                                                String.format("{\"email\":\"%s\"}",
                                                                                AuthObjectMother.validUserEmail)))
                                .andReturn();
        ...
        @Test
        void givenInvalidUserEmail_whenRequestingPasswordReset_thenChoosePasswordTokenShouldNotBeCreated()
                        throws Exception {
                ...
                var result = mockMvc.perform(
                                post("/auth/reset-password")
                                                ...
                                                .content(String.format("{\"email\":\"%s\"}",
                                                                AuthObjectMother.invalidUserEmail)))
                                .andReturn();
        ...
        @Test
        void givenInvalidChoosePasswordToken_whenGettingChoosePasswordTokenEmail_thenGetEmptyResponse()
                        throws Exception {
                var result = mockMvc.perform(
                                get("/auth/choose-password/randominvalidtoken")).andReturn();
        ...
        void givenLoggedInUser_whenGettingUserInfo_thenReceiveInfo() throws Exception {
                ...
                var result = mockMvc.perform(
                                get("/auth/info").cookie(authCookies)).andReturn();
                ...
                var result = mockMvc.perform(
                                post("/auth/change-password")
                                                ...
                                                .content(String.format(
                                                                "{\"oldPassword\":\"%s\",\"newPassword\":\"abc123\"}",
                                                                AuthObjectMother.validUserPassword)))
                                .andReturn();
        ...
        void givenIncorrectOldPassword_whenChangingPassword_thenPasswordShouldNotUpdate() throws Exception {
                ...
                var result = mockMvc.perform(
                                post("/auth/change-password")
                                                ...
                                                .content(String.format(
                                                                "{\"oldPassword\":\"%s\",\"newPassword\":\"abc123\"}",
                                                                AuthObjectMother.invalidUserPassword)))
                                .andReturn();
