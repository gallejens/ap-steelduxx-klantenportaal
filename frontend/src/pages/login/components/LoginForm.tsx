...
export const LoginForm: FC = () => {
	...
	const loginForm = useForm<LoginFormValues>({
		...
		validate: {
			...
			password: (value) => value.length === 0 && t("loginpage:passwordInputError"),
		},
	...
	return (
		<form className={styles.login_form} onSubmit={loginForm.onSubmit((values) => handleLoginButton(values))}>
			<TextInput
			...
			<div>
				...
				/>
				<Text className={styles.password_reset} c="dimmed" onClick={handleResetPassword}>
