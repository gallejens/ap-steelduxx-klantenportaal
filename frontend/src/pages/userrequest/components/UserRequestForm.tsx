...
export const UserRequestForm: FC = () => {
	...
	return (
		<form className={styles.userrequest_form} onSubmit={UserRequestForm.onSubmit((values) => handleUserRequestButton(values))}>
			...
			<div className={styles.go_login_userrequest_button}>
				<div className={styles.userrequest_button}>
					<Button type="submit">{t("userrequestpage:userRequestButton")}</Button>
				</div>
